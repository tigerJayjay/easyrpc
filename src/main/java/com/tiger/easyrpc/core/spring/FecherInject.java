...
@Component
public class FecherInject implements BeanPostProcessor {
    private Logger logger = LoggerFactory.getLogger(FecherInject.class);
    @Override
    public Object postProcessAfterInitialization(Object bean, String beanName) throws BeansException {
        ...
        for (Field declaredField : declaredFields) {
            ...
            url = PropertiesUtils.getPropertyValue("easyrpc.client.url");
            if(StringUtils.isEmpty(url)){
